...
function createSection (section, content, options) {
  ...
  var height = phantom.callback(function (pageNum, numPages) { return ((parseFloat(pageNum) % (parseFloat(numPages) / parseFloat(o.copies))) === 0) ? (letterHeadMargin || options.height) : options.height;})
  ...
  return {
    ...
    contents: phantom.callback(function (pageNum, numPages) {
      ...
      if (o.copies && o.copyFooter && ((parseFloat(pageNum) % (parseFloat(numPages)/parseFloat(o.copies))) === 0)) html = o.copyFooter
